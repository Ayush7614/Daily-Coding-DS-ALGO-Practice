/*
  Link : https://www.geeksforgeeks.org/traveling-salesman-problem-using-genetic-algorithm/

Approach: In the following implementation, cities are taken as genes, string generated using these characters is called a chromosome,
...
The fittest of all the genes in the gene pool survive the population test and move to the next iteration. 
