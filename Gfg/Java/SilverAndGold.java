/*
 * 
 * Implementation of Silver and Gold problem from JOB-A-Thon contest gfg
 * 
 * Problem statement:
 * 
 * There are N coins kept in a line. Each coin has two sides - one is colored gold
 * and the other silver. You can flip two adjacent coins any number of times. You need to make 
 * the gold-colored side of every coin facing up. You are given the initial status of coins
