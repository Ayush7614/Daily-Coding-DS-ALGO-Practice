...
TEST CASE 1:
    1. ARRAY IMPLEMENTATION
        1. Enqueue
            ...
            Enter the Priority Number of Data: 5
        1. Enqueue
            Enter the Data to be inserted: 36
            Enter the Priority Number of Data: 2
        1. Enqueue
            Enter the Data to be inserted: 69
            Enter the Priority Number of Data: 7
        1. Enqueue
            Enter the Data to be inserted: 41
            Enter the Priority Number of Data: 5
        3. Display
            Data             Priority
            25               5
...
TEST CASE 2:
    2. LINKED LIST IMPLEMENTATION
        1. Enqueue
            Enter the Data to be inserted: 85
            Enter the Priority Number of Data: 15
        1. Enqueue
            Enter the Data to be inserted: 96
            Enter the Priority Number of Data: 8
        1. Enqueue
            Enter the Data to be inserted: 42
            Enter the Priority Number of Data: 18
        1. Enqueue
            Enter the Data to be inserted: 32
            Enter the Priority Number of Data: 5
        1. Enqueue
            Enter the Data to be inserted: 845
            Enter the Priority Number of Data: 12
        3. Display
            Priority Queue:         32[Priority: 5]         96[Priority: 8]         845[Priority: 12]       85[Priority: 15]        42[Priority: 18]
        2. Dequeue
            Deleted Item: 32[Priority: 5]
        3. Display
            Priority Queue:         96[Priority: 8]         845[Priority: 12]       85[Priority: 15]        42[Priority: 18]
*/
