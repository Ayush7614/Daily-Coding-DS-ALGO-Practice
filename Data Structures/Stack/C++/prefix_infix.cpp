...
Infix expression : An expression in which the operator appears before the operands.
...
string prefix_to_infix(string prefix)
{
  ...
  // getting length of prefix expression
  int l=prefix.length();
...
prefix to infix expression is: ((a-(b/c))*((a/k)-l))
*/
